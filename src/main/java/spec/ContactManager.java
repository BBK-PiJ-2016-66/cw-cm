...
public interface ContactManager {
     ...
     *
     * An ID is returned when the meeting is put into the system. This ID must
     ...
     * @return the ID for the meeting
     * @throws IllegalArgumentException if the list of contacts is empty, if any
     * of the contacts does not exist, or if the date provided is in the future
     ...
     * @param text messages to be added about the meeting.
     * @return created past meeting with notes
    ...
    /**
     * Returns a set containing the contacts that correspond to the IDs. Note
